...
class ShopController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $records = Record::orderBy('artist', 'asc')
        ...
        $genres = Genre::orderBy('name', 'asc')            // short version of orderBy('name', 'asc')
...
//        // when eager loading
//        $records = Record::with(['students' => function ($q) {
...
//        return $this->hasMany('name')->orderBy('id', 'desc');
    }
}
